...
var o = (e, t) => oe(e, "name", { value: t, configurable: !0 }),
  A = ((e) =>
    typeof require < "u"
      ? require
      : typeof Proxy < "u"
...
var E = ["isConstructor", "isEval", "isNative", "isToplevel"],
  P = ["columnNumber", "lineNumber"],
  k = ["fileName", "functionName", "source"],
  ae = ["args"],
  ce = ["evalOrigin"],
  R = E.concat(P, k, ae, ce);
function p(e) {
...
for (b = 0; b < E.length; b++)
  (p.prototype["get" + S(E[b])] = L(E[b])),
    (p.prototype["set" + S(E[b])] = (function (e) {
      return function (t) {
        this[e] = !!t;
      };
    })(E[b]));
...
for (v = 0; v < P.length; v++)
  (p.prototype["get" + S(P[v])] = L(P[v])),
    (p.prototype["set" + S(P[v])] = (function (e) {
      return function (t) {
...
for (h = 0; h < k.length; h++)
  (p.prototype["get" + S(k[h])] = L(k[h])),
    (p.prototype["set" + S(k[h])] = (function (e) {
      return function (t) {
        this[e] = String(t);
      };
    })(k[h]));
...
var g =
    ...
    !process.browser,
  T = g && typeof module < "u" && typeof module.exports < "u" && typeof A < "u" && typeof __dirname < "u",
  j = g && !T,
  Te = typeof globalThis.Bun < "u",
  ue = typeof Deno < "u",
  H = !g && !ue,
  V =
    H &&
  ...
  z = H && typeof importScripts == "function" && typeof self == "object",
  De =
    typeof navigator == "object" &&
    typeof navigator.userAgent == "string" &&
    navigator.userAgent.indexOf("Chrome") == -1 &&
    navigator.userAgent.indexOf("Safari") > -1,
  x = typeof read == "function" && typeof load == "function";
var J, D, Y, q, U;
async function C() {
  if (
    !g ||
    ((J = (await import("node:url")).default),
    (q = await import("node:fs")),
    (U = await import("node:fs/promises")),
    (Y = (await import("node:vm")).default),
  ...
  let e = q,
    ...
    r = await import("ws"),
    s = await import("node:child_process"),
...
function pe(e, t) {
  return (
    ...
    e.includes("://")
      ? { response: fetch(e) }
      : { binary: U.readFile(e).then((r) => new Uint8Array(r.buffer, r.byteOffset, r.byteLength)) }
  );
}
...
async function be(e) {
  e.startsWith("file://") && (e = e.slice(7)),
    e.includes("://") ? Y.runInThisContext(await (await fetch(e)).text()) : await import(J.pathToFileURL(e).href);
}
o(be, "nodeLoadScript");
async function G(e) {
  if (g) {
    ...
    a = {
      ...
      getLocalSet: o((n) => {
        ...
        for (; d.length; ) {
          let u = d.pop(),
            f = t.stat(u);
          t.isDir(f.mode) && d.push.apply(d, t.readdir(u).filter(c).map(l(u))),
      ...
      getRemoteSet: o(async (n) => {
        let i = Object.create(null),
          c = await ve(n.opts.fileSystemHandle);
        for (let [l, d] of c)
          l !== "." &&
            (i[s.join2(n.mountpoint, l)] = {
      ...
      loadLocalEntry: o((n) => {
        ...
        if (t.isFile(l.mode))
          return (
            (c.contents = r.getFileDataAsTypedArray(c)), { timestamp: l.mtime, mode: l.mode, contents: c.contents }
          );
      ...
      storeRemoteEntry: o(async (n, i, c) => {
        let l = n.get(s.dirname(i)),
          d = t.isFile(c.mode)
            ? await l.getFileHandle(s.basename(i), { create: !0 })
            : await l.getDirectoryHandle(s.basename(i), { create: !0 });
        if (d.kind === "file") {
      ...
      reconcile: o(async (n, i, c) => {
        ...
        let u = [];
        if (
          (Object.keys(c.entries).forEach(function (m) {
        ...
        for (let m of u)
          if (c.type === "local") a.removeLocalEntry(m);
          else {
            let y = s.normalize(m.replace(n.mountpoint, "/")).substring(1);
...
function Ne(e) {
  ...
  return (
    ...
    [Ie(t), we(e.env.HOME), Ee(e.env), Z, ...Pe(e.fsInit)]
  );
}
o(Ne, "getFileSystemInitializationFuncs");
function Fe(e) {
  if (typeof WasmOffsetConverter < "u") return;
  let { binary: t, response: r } = F(e + "pyodide.asm.wasm"),
    s = te();
  return function (a, n) {
    return (
      (async function () {
...
async function at(e = {}) {
  ...
  let r = e;
  if (
    ((r.packageBaseUrl = _(r.packageBaseUrl)),
    (r.cdnUrl = _(r.packageBaseUrl ?? `https://cdn.jsdelivr.net/pyodide/v${B}/full/`)),
    !e.lockFileContents)
  ) {
  ...
  if (
    ...
    i.version !== B && a.checkAPIVersion)
  )
    throw new Error(
      `Pyodide version does not match: '${B}' <==> '${i.version}'. If you updated the Pyodide version, make sure you also updated the 'indexURL' parameter passed to loadPyodide.`
    );
  l.locateFile = (f) => {
    throw f.endsWith(".so")
...
o(at, "loadPyodide");
export { at as loadPyodide, B as version };
